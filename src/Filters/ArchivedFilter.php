...
/**
 * A filter implementation that shows all records, including archived records.
 *
 * @package SilverWare\ModelFilters\Filters
 * @author Colin Tucker <colin@praxis.net.au>
 * @copyright 2017 Praxis Interactive
...
class ArchivedFilter extends Filter
{
    ...
    {
        return _t(__CLASS__ . '.ALLRECORDSINCLUDINGARCHIVED', 'All records, including archived');
    }
    ...
    {
        return $this->getRecordsIncludingArchived();
    }
}
